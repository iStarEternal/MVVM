...
@property (nonatomic, copy) void(^imagePickerDidFinish)(UIImage *);
...
- (void)presentCameraWithComplete:(void (^)(UIImage *))complete {
    ...
    self.imagePickerDidFinish = complete;
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary<NSString *,id> *)info {
    [picker dismissViewControllerAnimated:true completion:NULL];
    self.imagePickerDidFinish(info[UIImagePickerControllerOriginalImage]);
}
...
- (WexViewController *)createViewController {
    self.viewController = [[WexFirstViewController alloc] initWithViewModel:self];
